...
cff_clean[cff_clean$Species_phylo == "Glossina_morsitans", "Species_phylo"] <- "Glossina_morsitans_morsitans"

#Cyanistes_caeruleus to XX
cff_clean[cff_clean$Species_phylo == "Cyanistes_caeruleus", "Species_phylo"] <- "Parus_caeruleus"


#Acromegalomma_vesiculosum to Branchiomma_vesiculosum
cff_clean[cff_clean$Species_phylo == "Acromegalomma_vesiculosum", "Species_phylo"] <- "Branchiomma_vesiculosum"

#Anisoptera, which is an infroorder of dragonflies to be represented by Sympetrum_flaveolum_ott906647
cff_clean[cff_clean$Species_phylo == "Anisoptera", "Species_phylo"] <- "Sympetrum_flaveolum"
...
cff_clean[cff_clean$Species_phylo == "Caretta_caretta", "Species_phylo"] <- "Caretta_caretta_HBS112700"


#Chelonia_mydas to Chelonia_mydas_HBS109887
cff_clean[cff_clean$Species_phylo == "Chelonia_mydas", "Species_phylo"] <- "Chelonia_mydas_HBS109887"

#Dermochelys_coriacea to Dermochelys_coriacea_MVZ149847
cff_clean[cff_clean$Species_phylo == "Dermochelys_coriacea", "Species_phylo"] <- "Dermochelys_coriacea_MVZ149847"


#Felis_domesticus to Felis_silvestris
cff_clean[cff_clean$Species_phylo == "Felis_catus", "Species_phylo"] <- "Felis_silvestris"


#Gekko_gekko to Gekko_gecko
cff_clean[cff_clean$Species_phylo == "Gekko_gekko", "Species_phylo"] <- "Gekko_gecko"


#Janicella_spinacauda to Janicella_spinicauda
cff_clean[cff_clean$Species_phylo == "Janicella_spinacauda", "Species_phylo"] <- "Janicella_spinicauda"


#Lycosa_baltimoriana to Lycosa_beihaiensis
cff_clean[cff_clean$Species_phylo == "Lycosa_baltimoriana", "Species_phylo"] <- "Lycosa_beihaiensis"


#Nematobrachian_boopis to Nematobrachion_boopis
cff_clean[cff_clean$Species_phylo == "Nematobrachian_boopis", "Species_phylo"] <- "Nematobrachion_boopis"

#Nematobrachion_sexpinosus to Nematobrachion_sexspinosum
cff_clean[cff_clean$Species_phylo == "Nematobrachion_sexpinosus", "Species_phylo"] <- "Nematobrachion_sexspinosum"


#Apis_mellifera, to Apis_mellifera_mellifera_ott13206
cff_clean[cff_clean$Species_phylo == "Apis_mellifera", "Species_phylo"] <- "Apis_mellifera_mellifera"


#Calliphoridae, which is all blowflies to be represented by Chrysomya_megacephala
#cff_clean[cff_clean$Species_phylo == "Calliphoridae", "Species_phylo"] <- "Chrysomya_megacephala"


#Change locusta_migratoria to Locustaevora_migratoriae
cff_clean[cff_clean$Species_phylo == "locusta_migratoria", "Species_phylo"] <- "Locustaevora_migratoriae"


#Change Pterois_Spp to Pterois_volitans
cff_clean[cff_clean$Species_phylo == "Pterois_spp", "Species_phylo"] <- "Pterois_volitans"


#Change Haplochromis_sauvagei to Haplochromis_luteus
cff_clean[cff_clean$Species_phylo == "Haplochromis_sauvagei", "Species_phylo"] <- "Haplochromis_luteus"
...
write.tree(final_tree, file = "cff_tree_18_july_2024.tree")
